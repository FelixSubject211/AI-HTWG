...
def solve():
    ...
    problem.addConstraint(AllDifferentConstraint(), ["Maier", "Müller", "Schmied", "Huber"])
    ...
    # 3
    problem.addConstraint(lambda schmied, mueller: abs(schmied - mueller) > 1, ["Schmied", "Müller"])
